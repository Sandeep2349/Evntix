...
const users = [
    { name: 'Admin User', email: 'admin@evntix.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@evntix.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@evntix.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@evntix.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@evntix.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@evntix.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@evntix.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@evntix.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@evntix.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@evntix.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@evntix.com');
        console.log('User Email:  user@evntix.com');
