        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-4">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">Download tickets instantly or manage them right from your personal dashboard easily.</p>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
                    <div className="w-16 h-16 bg-gray-900 text-white rounded-2xl flex items-center justify-center text-2xl mb-6 shadow-md shadow-gray-200/50">
                        <FaShieldAlt />
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">All transactions and registrations are protected by cutting-edge security and OTP tech.</p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {events.map((event) => {
                        ...
                        const percentageRemaining = event.totalSeats > 0
                            ? (availableSeats / event.totalSeats) * 100
                            : 0;

                        return (
                            <div key={event._id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition flex flex-col border border-gray-100">
                                ...
                                <div className="p-6 flex-grow flex flex-col">
                                    ...
                                    <div className="mt-auto pt-4 border-t border-gray-50">
                                        ...
                                        <p className="text-xs text-gray-500 mb-4">
                                            {availableSeats} of {event.totalSeats} seats remaining
                                        </p>
                                        <Link
                                            to={`/events/${event._id}`}
                                            className="block w-full text-center bg-gray-900 hover:bg-indigo-600 text-white font-semibold py-2.5 rounded-lg transition"
                                        >
                                            View Details
                                        </Link>
                                    </div>
